<%@ Control Language="C#" AutoEventWireup="true" CodeFile="~/CMSWebParts/GroupDocsViewerDotNet/GroupDocsViewerDotNet.ascx.cs" Inherits="CMSWebParts_GroupDocsViewerDotNet_GroupDocsViewerDotNet" %>
